...
gen_nohn_table(LastVisitCookie) ->
	...
	[<<"<!DOCTYPE html><html>">>,
			...
			<<"</style></head>">>,
		<<"<body>\n<h1 class=\"tooltip\">No old hacker news!<span>Heavy hackernews consumer? Have a peek every few minutes for new top stories and not interrested in old ones? This service greys old ones out and so you can focus on the latest shit.</span></h1>\n">>,
		<<"<table>\n">>,		
